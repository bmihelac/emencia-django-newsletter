...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SMTPServer.ssl'
        db.add_column('newsletter_smtpserver', 'ssl',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SMTPServer.ssl'
        db.delete_column('newsletter_smtpserver', 'ssl')
    ...
    models = {
        ...
        'newsletter.newsletter': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'header_reply': ('django.db.models.fields.CharField', [], {'default': "'info@status.si'", 'max_length': '255'}),
            'header_sender': ('django.db.models.fields.CharField', [], {'default': "'info@status.si'", 'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
